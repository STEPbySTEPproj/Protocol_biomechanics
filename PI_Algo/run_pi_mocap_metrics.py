...
def Generate_PI(argv):
    ...
    clas_ascend_descend = pickle.load(open("tests/data/protocol_1/input/models/model_descend_ascend.sav", 'rb'))
    ...
    if(descend==1):
        ...
        model=pickle.load(open("tests/data/protocol_1/input/models/model_descend.sav", 'rb'))
    else:
        #print("Loading ascend model")
        model=pickle.load(open("tests/data/protocol_1/input/models/model_ascend.sav", 'rb'))
